...
namespace SV20T1020042.Web.Controllers
{
	...
	public class AccountController : Controller
    {
        ...
        public IActionResult AccessDenined()
        {
            ...
            string message = "Tài khoản của bạn không được cấp quyền để truy cập trang này";

            // Mã hóa thông báo để có thể sử dụng trong mã JavaScript
            string encodedMessage = System.Web.HttpUtility.JavaScriptStringEncode(message);

            // Gán thông báo mã hóa vào ViewBag
            ViewBag.ErrorMessage = encodedMessage;
            return View();
        }
